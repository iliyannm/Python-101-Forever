def left_down_diagonal(mat, word, letter, row, col):
...
def left_horizontal(mat, word, letter, row, col):
    while col - 1 >= 0:
        col -= 1
        letter += mat[row][col]
        if letter == word:
...
def left_up_diagonal(mat, word, letter, row, col):
...
def upper_vertical(mat, word, letter, row, col):
    while row - 1 >= 0:
        row -= 1
        letter += mat[row][col]
        if letter == word:
...
def right_up_diagonal(mat, word, letter, row, col):
...
def right_horizontal(mat, word, letter, row, col):
...
def right_down_horizontal(mat, word, letter, row, col):
...
def down_vertical(mat, word, letter, row, col):
    while row + 1 < len(mat):
        row += 1
        letter += mat[row][col]
        if letter == word:
